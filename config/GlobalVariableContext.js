...
const DeviceVariables = {
  auth_header:
    'eyJhbGciOiJBMjU2S1ciLCJlbmMiOiJBMjU2Q0JDLUhTNTEyIiwiemlwIjoiREVGIn0.hYUpe6ntwcbJDaHPsVFpHejSwASIjGhWXINhyQL8jmQN29bVTRdErdmHLRy345g12XAGaHZcLRRygGYMnM8Wlov8YyVmC2bf.PwHBZnJ_DUTf0BUj6cABfA.eL0IvX_YktlsVKun-GCvvo2Xpvaxsd9JTpL9P7wq-sWJBrsVuaNYOnI9QqFNuS6k-6AAdDEAiDZSFNul7XSThG4eL7DX0Q7aFdT2rEGvBa7V_-VuMdCOk-Sfx4poWFAKTrpz3AEFhDPzV8rwkfg06V-IZxuq-p24jzeL3avuivU.k_6XAeEjxDpxIoV_FG2_oZbLa-LjZt6cb9oKNTPT-FY',
  isLoggedIn: '',
  response: '',
  testhardcode_authheader: 'x',
  user_email: 'some user_email',
  user_fullname: 'some user_fullname',
  user_id: 38,
  user_username: 'some user_username',
};
const AppVariables = {
  Airtable_Authorization: 'Bearer keyvZ5cUKMEuFyZ89',
  Amplitude_Authorization: 'bfbedddb365e0ee170a27efed5aa528f',
  Dev_Amplitude_Authorization: '1d68873ec73bc86c1928b25dbecfa98d',
  Error_Message_Auth: '',
  Spotify_Authorization:
    'Bearer BQCEJ2RW5TO2S63lS_2FQP7vXA2Ds45w2cGUAumlNgNZkd67cjmFVamP',
};
